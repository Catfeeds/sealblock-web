...
import com.woodare.template.component.cache.PasswayRouteMerchantListener;
...
public class ContextLoaderListener extends org.springframework.web.context.ContextLoaderListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		try {
			...
			// SystemCache.registListener(PasswayRouteSettingData.class, new PasswayRouteSettingListener());
			SystemCache.registListener(PasswayRouteMerchantData.class, new PasswayRouteMerchantListener());
