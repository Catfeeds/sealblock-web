...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public List<String> getRoles(String userId) {
		...
		// 非代理商 &非商户&未绑定Token
		if (!EnumUserRole.AGENT.equals(systemUser.getUserRole())
				//
				&& !EnumUserRole.USER.equals(systemUser.getUserRole())
				//
				&& systemUser.getAuthBindDate() == null
				//
				&& !"dev".equals(SysProperties.getInstance().getProperty("deploy.mode"))) {
			roles.add("ROLE_NOAUTH");
		}
		else {
