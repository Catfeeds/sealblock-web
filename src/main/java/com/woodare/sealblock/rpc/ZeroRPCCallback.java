 ...
 * assignable from {@link ZeroRPCCallback} the server won't explicitly wait for the
 ...
 * </pre>
 */
public interface ZeroRPCCallback {
	 ...
	 *            the result if any
	 */
	public void onError(Object error, Throwable e);
}
