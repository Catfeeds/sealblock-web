...
/**
 * ClassName: SearchDownMerchantDepositViewData
 * 
 * @description
 * @author to_be_replaced_by_owner
 * @Date 2017/01/09
 */
public class SearchDownMerchantDepositViewData extends SearchDownMerchantDepositData implements ISearchData {
