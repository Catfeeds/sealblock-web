...
/**
 * ClassName: ContentDownNoCardInvoiceController
 * 
 * @description
 * @author Luke
 * @Date Mar 2,2018
 */
@Controller
@RequestMapping("/content/downNoCardInvoice")
public class ContentDownNoCardInvoiceController extends BaseController {
	...
	public ModelAndView sum(SearchDownNoCardInvoiceViewData searchData) throws ControllerException {
		ModelAndView mav = new ModelAndView(getTemplate("/content/downNoCardInvoice/sum"));
	...
	public ModelAndView index(SearchDownNoCardInvoiceViewData searchData) throws ControllerException {
		return showIndex(getTemplate("/content/downNoCardInvoice/index"), searchData, null);
	}
	...
	public ModelAndView add(DownNoCardInvoiceViewData data) throws ControllerException {
		ModelAndView mav = new ModelAndView(getTemplate("/content/downNoCardInvoice/details"));
