...
<form class="search-form" action="<c:url value="/admin/subMerchant/index" />" method="post">
	...
	<a href="<c:url value="/admin/subMerchant/add" />" class="btn btn-orange pull-right operate-detail" >新建</a>
</form>
<table class="list-wapper">
	...
	<c:forEach var="item" items="${res.items}" varStatus="itemStatus" >
		<tr class="list-item">
			...
			<td>
				<a href="<c:url value="/admin/subMerchant/add?id=${item.id}" />" class="choose-link operate-detail">编辑</a>
