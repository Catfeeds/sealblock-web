 ...
 *                                                                             
 *****************************************************************************/
package com.woodare.core.jpa.data.systemuser;
 ...
 * @Date 2014/10/11
 */
public class SystemUserData extends AbstractData {
	...
	/**
	 * @return the authBindDate
	 */
	public Date getAuthBindDate() {
		return authBindDate;
	}

	/**
	 * @param authBindDate
	 *            the authBindDate to set
	 */
	public void setAuthBindDate(Date authBindDate) {
		this.authBindDate = authBindDate;
	}
