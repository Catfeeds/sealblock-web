...
<head>
	...
	<script type="text/javascript" src="<spring:url value="/resources/js/test/app.js"></spring:url>?<%=new java.util.Date().getTime()%>"></script>
</head>
<body>
	<div class="container">  
		<div id="tabs" style="width: 48%; margin-left: 1%; float: left; height: 98%; overflow: hidden;">
		    <ul>
		        <li><a href="<c:url value='/api/app/qrcode/index' />">码终端管理</a></li>
		    </ul>
