...
<div class="index_content" style="overflow:hidden;">
	...
	<DIV class="panel index_pro"><DIV class="ppro-body clearfix">
		<div class="col-lg-12">
			<H4>${mch.name }(${mch.mchNo})  <c:if test="${allowFlag eq 'Y' }">
				<form style='display: inline;' action="<c:url value='/content/home/directPay' />" 
					target='_blank' method="get"><input type="submit" value="站内收款" 
					style="line-height: 32px; height: 32px; padding: 0 10px;"
					class="btn btn-orange export-btn" ></form></c:if></H4>
		</div>
		<div class="col-lg-12">
