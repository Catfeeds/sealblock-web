...
<form class="search-form" action="<c:url value="/content/downMerchantDeposit/sum" />" method="post">
...
<%-- <form action="<c:url value="/content/downMerchantDeposit/exportSum" />" target="_blank" method="post" class="export-form">
