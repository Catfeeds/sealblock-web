...
<body class="login" mycollectionplug="bind">
	...
	<div class="login_m">
		<div class="login_logo">
			<img src="https://xtraex.com/pnk-admin/style/images/logo4.png" style="padding: 0 0 10px;">
			<h2>运营管理平台</h2>
		</div>
		<c:if test="${not empty errorMsg}">
			<div class="login-line error-message">${errorMsg}</div>
		</c:if>
		<div class="login_boder" style="height: 270px;">
			<div class="login_padding" id="login_model">
				...
				<form method="post" name="login" action="${loginurl }">
					...
					<h2>二次验证</h2>
					<label>
						<input type="text" class="txt_input input-box-code" placeholder="可空" name="regcode" autocomplete="off" />
					</label>
					<div class="rem_sub">
						<!-- <div class="rem_sub_l">
