...
<main class="MyContent bottom0 orderPayCon">
	<form action="<c:url value="/directpay/bindcard"/>" id="submit-form" method="post">
	...
	<div class="CardPayBox" style="margin-top:1.5rem;">
		...
		<p class="CardNum fix btNone">
			...
			<span class="input-wapper fl" >
				<input type="text" class="card-input" placeholder="预留手机号" autocomplete="off" name="userToken" >
			</span>
		</p>
		<p class="CardNum fix btNone">
		...
		<div class="fix conBtnBox"><div class="ml10 mr10"><input id="ChuPayFor" type="button" class="pay-btn bg_red" onclick="check()" value="确认授权"></div></div>
	</div>
