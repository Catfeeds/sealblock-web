		...
		<table class="liner-box">
			...
			<tr>
				...
				<td class="liner-box-right">
					...
					<input type="text" class="input-box" placeholder="" value="<fmt:formatNumber value="${(item.settleInAmt - item.settleOutAmt) / 100}" pattern="#,##0.00#"/>" />元
				</td>
			</tr>
			<tr>
				...
				<td class="liner-box-right">
					...
					<input type="text" class="input-box" placeholder="" value="<fmt:formatNumber value="${(item.curInAmt - item.curOutAmt) / 100}" pattern="#,##0.00#"/>" />元
				</td>
			</tr>
			<tr>
				...
				<td class="liner-box-right">
					...
					<input type="text" class="input-box" placeholder="" value="<fmt:formatNumber value="${item.frozenAmt / 100}" pattern="#,##0.00#"/>" />元
				</td>
			</tr>
			<tr>
