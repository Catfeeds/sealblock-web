...
<form class="search-form" action="<c:url value="/content/downNoCardInvoice/sum" />" method="post">
...
<%-- <form action="<c:url value="/content/downNoCardInvoice/exportSum" />" target="_blank" method="post" class="export-form">
